			...
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" id="mytext" class="form-control"
						ng-model="search" ng-init="search='${param.searchkeyword}'" />
				</div>
			</div>
		</form>
		<hr>
				...
				<tr>
					<th><a href="#"
						ng-click="sortType = 'name'; sortReverse = !sortReverse">
							Product ID <span ng-show="sortType == 'name' && !sortReverse"
							class="fa fa-caret-down"></span> <span
							ng-show="sortType == 'name' && sortReverse"
							class="fa fa-caret-up"></span>
					</a></th>
					<th><a href="#"
						ng-click="sortType = 'tastiness'; sortReverse = !sortReverse">Name
					...
					<th><a href="#"
						ng-click="sortType = 'tastiness'; sortReverse = !sortReverse">
							Photos <span ng-show="sortType == 'tastiness' && !sortReverse"
							class="fa fa-caret-down"></span> <span
							ng-show="sortType == 'tastiness' && sortReverse"
							class="fa fa-caret-up"></span>
					</a></th>
				...
				<c:forEach items="${productList}" var="user">
					...
					<tr ng-repeat="x in  myData | filter:search">
						...
						<td><img height="100px" width="100px"
							src="<c:out value="resources/images/${user.ID}.jpg"/>" /></td>
