...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="item active">
        <img class="img-responsive" src="resources/images/s1.jpg" width="1200px" height="500px">
      </div>
      <div class="item">
        <img class="img-responsive" src="resources/images/s7.jpg" width="1200px" height="500px" >
      </div>
      <div class="item">
        <img class="img-responsive" src="resources/images/s3.jpg" width="1200px" height="500px" >
      </div>
      <div class="item">
        <img class="img-responsive" src="resources/images/s4.jpg" width="1200px" height="500px" >
      </div>

      <div class="item">
        <img class="img-responsive" src="resources/images/s5.jpg"  width="1200px" height="500px">
      </div>
